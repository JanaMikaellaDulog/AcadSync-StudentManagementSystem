...
public class CustomButtonUpdate3 extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonUpdate3(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(95, 127, 113);   // Hover background
        setUI(new javax.swing.plaf.basic.BasicButtonUI()); // Basic UI allows customization
        setBackground(new Color(186, 239, 213)); // Default background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(186, 239, 213)); // Change to hover background
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getModel().isPressed()) {
            g2.setColor(new Color(186, 239, 213)); // Pressed state color
        } else {
