...
public class CustomButtonDelete1 extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonDelete1(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(198, 0, 72);   // Hover background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(232, 0, 85)); // Change to hover background
            }
        });
    }
