...
public class CustomButtonAdd4 extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonAdd4(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(159, 14, 114);   // Hover background
        setUI(new javax.swing.plaf.basic.BasicButtonUI()); // Basic UI allows customization
        setBackground(new Color(228, 21, 163)); // Default background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(228, 21, 163)); // Change to hover background
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getModel().isPressed()) {
            g2.setColor(new Color(228, 21, 163)); // Pressed state color
        } else {
