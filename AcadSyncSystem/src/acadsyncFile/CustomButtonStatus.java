...
public class CustomButtonStatus extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonStatus(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(200, 76, 40);   // Hover background
        setUI(new javax.swing.plaf.basic.BasicButtonUI()); // Basic UI allows customization
        setForeground(new Color(0, 0, 0)); 
        setBackground(new Color(255, 102, 54)); // Default background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(255, 102, 54)); // Change to background
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getModel().isPressed()) {
            g2.setColor(new Color(255, 102, 54)); // Pressed state color
        } else {
