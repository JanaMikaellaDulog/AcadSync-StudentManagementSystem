...
public class CustomButtonSubject extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonSubject(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(39, 145, 148);   // Hover background
        setUI(new javax.swing.plaf.basic.BasicButtonUI()); // Basic UI allows customization
        setForeground(new Color(0, 0, 0)); 
        setBackground(new Color(32, 117, 120)); // Default background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(32, 117, 120)); // Change to background
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getModel().isPressed()) {
            g2.setColor(new Color(32, 117, 120)); // Pressed state color
        } else {
