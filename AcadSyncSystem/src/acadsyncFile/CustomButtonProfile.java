...
public class CustomButtonProfile extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonProfile(String text, int cornerRadius) {
        super(text);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(36, 248, 255)); // Change background
            }
        });
    }
