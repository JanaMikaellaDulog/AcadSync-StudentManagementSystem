...
public class CustomButtonGrades extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonGrades(String text, int cornerRadius) {
        ...
        this.hoverBackground = new Color(195, 0, 71);   // Hover background
        setUI(new javax.swing.plaf.basic.BasicButtonUI()); // Basic UI allows customization
        setForeground(new Color(0, 0, 0)); 
        setBackground(new Color(232, 0, 85)); // Default background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(232, 0, 85)); // Change to background
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getModel().isPressed()) {
            g2.setColor(new Color(232, 0, 85)); // Pressed state color
        } else {
