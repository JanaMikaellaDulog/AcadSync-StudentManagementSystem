...
public class CustomButtonUpdate1 extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonUpdate1(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(196, 140, 16);   // Hover background
