...
public class CustomButtonAdd1 extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonAdd1(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(191, 76, 40);   // Hover background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(255, 102, 54)); // Change to hover background
            }
        });
    }
