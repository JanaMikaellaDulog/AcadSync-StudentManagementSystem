...
public class CustomButtonClear4 extends JButton {
    /**
	 * 
	 */
    ...
    public CustomButtonClear4(String text, int cornerRadius) {
        super(text);
        this.cornerRadius = cornerRadius;
        this.hoverBackground = new Color(174, 50, 159);   // Hover background
        setUI(new javax.swing.plaf.basic.BasicButtonUI()); // Basic UI allows customization
        setBackground(new Color(137, 4, 121)); // Default background
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) { 
                setBackground(new Color(137, 4, 121)); // Change to hover background
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getModel().isPressed()) {
            g2.setColor(new Color(137, 4, 121)); // Pressed state color
        } else {
